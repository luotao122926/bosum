...
public class CorsFilter implements WebFilter, Ordered {
    ...
    private static final String HEADERS ="Origin, Cache-Control, No-Cache, Pragma, Access-Control-Max-Age,X-Requested-With, X_Requested_With, Content-Type, Content-Disposition, Content-Length, Date, Accept,REQUEST_SOURCE,CLIENT_TYPE,Authorization,Clienttype";
